...
### 2.1 `pages/AccountPage/ThemeEditor.tsx` reimplements multiple Common inputs
...
### 4.6 Inline `display: "none"` on hidden file inputs
...
### 4.7 Inline `style={{ width: 240 }}` / `{ width: 80, height: 80 }` on image previews
