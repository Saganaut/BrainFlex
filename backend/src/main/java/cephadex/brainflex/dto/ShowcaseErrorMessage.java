 ...
 * ShowcaseWebSocketController throws. Lets the host (or any participant) see
...
public record ShowcaseErrorMessage(
        String operation,   // matches the /app/showcase/{code}/<operation> suffix (e.g. "start")
        String roomCode,
