/**
 * Public catalog projection of {@link cephadex.brainflex.model.user.Achievement}.
 *
...
public record AchievementResponse(
     ...
     */
    public static AchievementResponse revealed(Achievement a) {
     ...
     */
    public static AchievementResponse masked(Achievement a) {
        return new AchievementResponse(
