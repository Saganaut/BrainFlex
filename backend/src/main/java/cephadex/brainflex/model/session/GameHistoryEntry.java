...
public class GameHistoryEntry {
    ...
    /** Streak / accuracy / reactionsSent copied verbatim off the matching
     *  {@link PlayerPlacement} at write time. Same shape lives on
     *  {@link InteractiveSessionPlayer} during play. */
    private PlayerEndStats endStats = PlayerEndStats.empty();

    /** Snapshot of {@code InteractiveSessionPlayer.currentStreak} at game end.
     *  Lives outside {@link #endStats} because it is history-only (no
     *  counterpart on PlayerPlacement). */
