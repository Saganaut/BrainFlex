 ...
 * active Showcase. Stores recent timestamps in a Redis ZSET keyed by
...
public class ShowcaseRateLimiter {
    ...
    private static final Logger log = LoggerFactory.getLogger(ShowcaseRateLimiter.class);
    ...
    public ShowcaseRateLimiter(StringRedisTemplate redis) {
        this.redis = redis;
    }
