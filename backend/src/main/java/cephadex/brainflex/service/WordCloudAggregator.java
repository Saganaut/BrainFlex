...
public final class WordCloudAggregator {
    ...
    private static String normalize(String raw, WordCloudQuestion q) {
        ...
        if (!q.caseSensitive()) trimmed = trimmed.toLowerCase(Locale.ROOT);
        return trimmed;
    }
