/**
 * Integration tests for ShowcaseController REST endpoints.
...
class ShowcaseControllerTest {
        ...
        void setUp() {
                ...
                ShowcasePlayer hostPlayer = new ShowcasePlayer();
        ...
        void getSession_WithValidRoomCode_ReturnsSession() throws Exception {
                ...
                mockMvc.perform(get("/api/showcases/ABCD12"))
        ...
        void getSession_WithInvalidRoomCode_ReturnsNotFound() throws Exception {
                ...
                mockMvc.perform(get("/api/showcases/XXXXXX"))
        ...
        void cancelGame_AsHost_ReturnsNoContent() throws Exception {
                ...
                mockMvc.perform(delete("/api/showcases/ABCD12"))
        ...
        void cancelGame_AsNonHost_ReturnsForbidden() throws Exception {
                ...
                org.mockito.Mockito.doThrow(new ResponseStatusException(
                                ...
                                .when(gameService).cancelShowcase(anyString(), any(User.class));
