// Audience-and-display options for the currently selected Slide — wired into
// the pencil-icon ("edit") drawer in RightSidebarContent. Mirrors the shared
// `useElementEditor` pattern used by SlideContentTypes: local state mirrors the
// server value, edits debounce through `schedule`, and structural toggles
// commit immediately so the cache resync is instant. Lives next to ThemePanel
// because both are drawers in the same right rail.
